...
elseif(preg_match("#^/setpass#is",$message))
  ...
  if(substr_count($msg,"/b ")>0 && $_SESSION['slevel'][5]==1) $msg="<b>".str_replace("/b ","",$msg)."</b>";
  if(substr_count($msg,"/i ")>0 && $_SESSION['slevel'][6]==1) $msg="<i>".str_replace("/i ","",$msg)."</i>";
  if(substr_count($msg,"/beg ")>0 && $_SESSION['slevel'][8]==1) $msg="<br><marquee>".str_replace("/beg ","",$msg)."</marquee>";
  }
?>